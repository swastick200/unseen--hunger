      ...
      <section className="admin-shell">
        ...
        {deployStatus ? (
          <div className="admin-card">
            <p className="admin-subtext">
              Backend mode: {deployStatus.storageMode}.
              {" "}
              {deployStatus.adminConfigured
                ? "Owner login is configured for this deployment."
                : "Set ADMIN_TOKEN in your deployment environment to enable owner login."}
            </p>
          </div>
        ) : null}
          ...
          <form className="admin-login" onSubmit={handleSaveToken}>
            ...
            <div className="admin-login-row">
              ...
              <button
                ...
                type="submit"
                disabled={deployStatus ? !deployStatus.adminConfigured : false}
              >
                Unlock
              </button>
            </div>
