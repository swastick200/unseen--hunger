...
export default function HomePage() {
  ...
  const liveFeedbackUnavailable =
    deployStatus && !deployStatus.localMode && !deployStatus.feedbackConfigured;
        ...
        <section className="section feedback-section" id="feedback">
          <div className="feedback-panel reveal">
            ...
            <form className="feedback-form" onSubmit={handleFeedbackSubmit}>
              ...
              <button className="button button-primary" type="submit" disabled={liveFeedbackUnavailable}>
                Submit Feedback
              </button>
              {liveFeedbackUnavailable ? (
                <p className="feedback-status">
                  Feedback is temporarily unavailable while the live site setup is being completed.
                </p>
              ) : null}
